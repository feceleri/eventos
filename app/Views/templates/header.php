        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-9" style="text-align: right;">
                    ...
                    <a accesskey="1" href="javascript:void(0);" class="anchor acess" id="conteudo" title="conteudo" onclick="abrirConteudo()">
                        ir para conteudo <span>1</span>
                    </a>
                    <a accesskey="2" href="javascript:void(0);" class="anchor acess" id="menu" title="menu" onclick="abrirMenu()">
                        ir para menu <span>2</span>
                    </a>
                    <a accesskey="3" href="javascript:void(0);" class="anchor acess" id="rodape" title="rodapé" onclick="abrirRodape()">
