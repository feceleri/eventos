                            ...
                            <form class="form-signin" name='form1' method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <input type="text" id="titulo" name="titulo" class="form-control col-12" placeholder="Titulo" maxlength="100" minilength="3" required autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group data" id="inicial" style="margin-left: 21%; margin-top: -6%;">
                                    <div class="form-label-group">
                                        ...
                                        <input id="dateE" type="date" name="dataExc">
                                    </div>
                                </div>
